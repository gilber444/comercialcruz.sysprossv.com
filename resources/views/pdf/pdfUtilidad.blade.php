    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:10%;">Facturador</th>
                <th style="width:22%;">Producto</th>
                <th class="text-center" style="width:7%;">Cant.</th>
                <th class="text-right" style="width:9%;">Costo U.</th>
                <th class="text-right" style="width:9%;">T. Costo</th>
                <th class="text-right" style="width:9%;">Precio U.</th>
                <th class="text-right" style="width:9%;">T. Venta</th>
                <th class="text-right" style="width:9%;">Utilidad</th>
