<ul class="menu-inner">
    ...
    @can('AdminEmpresa_Index')
        ...
        <li
            ...
            class="menu-item {{ Request::is('empresa') ? 'active' : '' }} {{ Request::is('sucursales') ? 'active' : '' }} {{ Request::is('parametros') ? 'active' : '' }} {{ Request::is('features') ? 'active' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                @can('Features_Index')
                    ...
                    <li class="menu-item {{ Request::is('features') ? 'active' : '' }}">

                        <a href="{{ route('features') }}" class="menu-link">

                            <div data-i18n="Features">Features / Versiones</div>
