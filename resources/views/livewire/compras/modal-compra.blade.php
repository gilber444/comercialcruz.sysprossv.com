        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="input-group input-group-merge">
                    ...
                    <input type="text" wire:model='search' id="modal-search-input" placeholder="Buscar por nombre, código de barras o categorías" class="form-control">
                </div>
            </div>
                    ...
                    <table class="table table-hover table-sm">
                        ...
                        <tbody>
                            @forelse ($products as $product)
                                <tr tabindex="0"> <!-- Agregar tabindex para permitir el enfoque -->
                                    ...
                                    <td class="text-center">
                                        <button wire:click.prevent="Add({{ $product->id }})" class="btn btn-primary">
        ...
        modal.addEventListener('keydown', function (event) {
            ...
            if (event.key === 'ArrowDown') {
                ...
                if (addButton) {
                    addButton.click();
                    setTimeout(() => {
                        $('#modalSearchProduct').modal('hide'); // Cierra el modal después de agregar producto
                    }, 500);
                }
            }
        });
