<div wire:ignore.self class="modal fade" id="ProveedorCompra" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModal">Nuevo Proveedor
                </h5>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 mb-3">
                        ...
                        <div class="input-group" wire:ignore>
                            <select class="form-select select2" wire:model='actividad' id="ActiProveedor" style="width: 100%">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id='editar' wire:click.prevent="SaveProveedor()" wire:keydown.alt.s.away='Update()' class="btn btn-primary"><i class='bx bx-revision'></i> Guardar Datos</button>
            </div>
        </div>
    </div>
</div>
