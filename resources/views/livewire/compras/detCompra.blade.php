<div wire:ignore.self class="modal fade" id="detalleCompraModal" tabindex="-1" style="display: none;" aria-hidden="true">
                                ...
                                <tbody class="">
                                    @foreach ($detalleCompras as $det)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($det->estado_compras !== 'Anulado' && $det->estado_compras !== 'Realizado')
