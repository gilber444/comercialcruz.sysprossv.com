...
<script>
    ...
    // Scroll automático al navegar con teclado por los inputs
    document.addEventListener('focusin', function (e) {
        const input = e.target;
        if (input.classList.contains('input-cantidad')) {
            ...
            if (fila && contenedor) {
                ...
                if (filaRect.bottom > contenedorRect.bottom) {
                    contenedor.scrollTop += filaRect.bottom - contenedorRect.bottom + 8;
                } else if (filaRect.top < contenedorRect.top) {
                    contenedor.scrollTop -= contenedorRect.top - filaRect.top + 8;
                }
            }
        }
    });
