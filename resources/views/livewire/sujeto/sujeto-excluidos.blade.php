            ...
            <tbody>
                @foreach ($sujetos as $sujeto)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $sujeto->created_at }}</td>
                        <td class="text-center">{{ $sujeto->observaciones ?? '-' }}</td>
                        ...
                        <td class="text-center">
                            ...
                            @endcan
                            <button type="button" class="btn btn-label-primary btn-sm" wire:click='Generar({{ $sujeto->id }})'>Generar</button>
                        </td>
                    </tr>
                    @endif
                @endforeach
