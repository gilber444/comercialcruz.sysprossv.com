            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 mb-3">
                        ...
                        @error('tipoPersona') <span class="text-danger er">{{ $message}}</span>@enderror
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-12 mb-3">
                        ...
                        <div class="input-group" wire:ignore>
                            <select class="form-select select2" wire:model='actividadCliente' id='actividadCliente'>
                        ...
                        @error('clienteAddSelectId') <span class="text-danger er">{{ $message}}</span>@enderror
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-4 mb-3">
                        ...
                        @error('departamento') <span class="text-danger er">{{ $message}}</span>@enderror
                    </div>
                    <div class="col-sm-12 col-md-4 mb-3">
                    ...
                    <div class="col-sm-12 col-md-3 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" wire:model.lazy='nit' class="form-control" placeholder="00000000000000">
                        </div>
                ...
                <div class='row'>
                    <div class="col-sm-12 col-md-2 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            <select class='form-control' wire:model='idenReceptor' >
                        ...
                        @error('idenReceptor') <span class="text-danger er">{{ $message}}</span>@enderror
                    </div>
                    <div class="col-sm-12 col-md-3 mb-3">
                    ...
                    <div class="col-sm-12 col-md-3 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" wire:model.lazy='celular' class="form-control" placeholder="00000000">
                        </div>
                    ...
                    <div class="col-sm-12 col-md-4 mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" wire:model.lazy='correo' class="form-control" placeholder="cliente@comercialidalia.com">
                        </div>
