            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-label-warning" href="javascript:void(0);" wire:click="Edit('{{$cliente->id}}')"><i class="bx bx-edit-alt"></i></a>
                        <a class="btn btn-label-danger" href="javascript:void(0);" onclick="Confirm('{{$cliente->id}}')"><i class="bx bx-trash"></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
