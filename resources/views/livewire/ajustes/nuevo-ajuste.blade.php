<div class="card shadow-none border border-primary mb-2">
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="d-grid">
            ...
            @endif
            <button type="button" class="btn btn-primary btn-next @if ($itemsQuantity == 0) disabled @endif"
                wire:click.prevent="Store()"><i class="fa-solid fa-cash-register"></i> Procesar Ajuste (F10)</button>
        </div>
    </div>
    <div class="card-body">
        <div id="checkout-cart" class="content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 mb-3 mb-xl-0" style="max-height: 500px; overflow-y: auto;">
                    @include('livewire.ajustes.detalle')
                    @include('livewire.ajustes.detalle-precios')
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <!-- Price Details -->
                    @include('livewire.ajustes.total')
                </div>
            </div>
        </div>
    </div>
