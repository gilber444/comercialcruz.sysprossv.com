...
trait RecepcionDTEC
{
    ...
    /**
     * Envía un DTE de Crédito Fiscal a recepción de Hacienda.
    ...
    public function RecepcionDTEC($id)
    {
        try {
            ...
            $firma = $this->obtenerOFirmarDTEC($id, $dte);
            ...
            $this->guardarRespuestaExitosaC($id, $dte, $responseData);

        } catch (ClientException $e) {
            $this->guardarRespuestaRechazadaC($id, $e);
            return;
        } catch (RequestException $e) {
            $this->guardarErrorRecepcionC($id, 'Error de conexión con Hacienda: ' . $e->getMessage());
            throw $e;
        } catch (\Throwable $e) {
            $this->guardarErrorRecepcionC($id, 'Error inesperado: ' . $e->getMessage());
            throw $e;
        }
     ...
     */
    private function obtenerOFirmarDTEC($id, $dte): ?string
    {
     ...
     */
    private function guardarRespuestaExitosaC($id, dte $dte, array $responseData): void
    {
     ...
     */
    private function guardarRespuestaRechazadaC($id, ClientException $e): void
    {
     ...
     */
    private function guardarErrorRecepcionC($id, string $mensaje): void
    {
        RecepcionDte::create([
            'dte' => $id,
            'fechaRecepcion' => Carbon::now()->toDateString(),
