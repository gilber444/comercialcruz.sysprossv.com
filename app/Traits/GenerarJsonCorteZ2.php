...
trait GenerarJsonCorteZ2
{
    public function GenerarJsonCorteZ2($id)
    {
        $c = Cortes::find($id);
        $tipo = 'CorteZ';
        $impresora = '80';
        ...
        //$company = Sucursales::join('empresas as e', 'e.id', 'sucursales.empresa')->select('e.empresa', 'e.registro', 'e.giro', 'e.nit', 'sucursales.direccion', 'e.razon')->find($c->sucursal);
