...
trait TraitTikets
{
    public function TraitTikets($id)
    {
        $user = Auth::user();
        ...
        $venta = Caja::with(['Rventas.Rclientes', 'Rcajas', 'Rcortes', 'Rcajeros'])->find($id);
        ...
        if($dte)
        {
            $qrCodeText = "https://comercialcruz.sysprossv.com/report/pdf/".$dte->codigoGeneracion;
        }
        else
        {
            $qrCodeText = "https://comercialcruz.sysprossv.com/report/pdf";
        }
