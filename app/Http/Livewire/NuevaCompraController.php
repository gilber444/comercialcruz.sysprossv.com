        ...
        try
        {
            ...
            if($compra)
            {
                ...
                foreach($items as $item)
                {
                    ...
                    if($existencia)
                    {
                        ...
                        Kardex::create([
                            ...
                            'ingresoValor' => $costo * $item->quantity,
                            'egresoCantidad' => 0.00,
                            'egresoValor' => 0.00,
                    ...
                    else
                    {
                        ...
                        Kardex::create([
                            ...
                            'egresoCantidad' => 0.00,
                            'egresoValor' => 0.00,
                            'saldoCantidad' => $item->ingreso,
                            'saldoValor' => $costo * $item->quantity
                        ]);
                    }
                }
                if($item->newcosto <> 0.00)
                {
                    ...
                    //$precios->pventasiva = $ppventa / $precios->cantidad;
                    //$precios->pvventa = $ppventa;
                    $precios->save();
            ...
            if ($this->condiPago === 'Credito')
            {
                ...
                CuentasPagar::create([
                    'compra' => $compra->id,
                    'proveedor' => $this->proveedorSelectId,
                    'monto_total' => $items->sum('total')*1.13,
                    'saldo' => $items->sum('total')*1.13,
                    'estado' => 'pendiente',
