...
return new class extends Migration
{
    ...
    {
        Schema::create('anulaciones_detalles', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('anulacion');
            $table->foreign('anulacion')->references('id')->on('anulaciones');
    ...
    {
        Schema::dropIfExists('anulaciones_detalles');
    }
};
